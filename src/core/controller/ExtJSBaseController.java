...
public abstract class ExtJSBaseController<E extends ExtJSBaseParameter>
{
  ...
  @RequestMapping({"/save"})
  public void doSave(E entity, HttpServletRequest request, HttpServletResponse response)
    throws IOException
  {
  ...
  public void doContent(@PathVariable("id") Serializable id, HttpServletRequest request, HttpServletResponse response)
    throws IOException
  {
    Class<E> c = (Class)((java.lang.reflect.ParameterizedType)getClass().getGenericSuperclass()).getActualTypeArguments()[0];
    ...
    E entity = (E)this.service.get((Serializable)ConvertUtils.convert(id, returnClass));
