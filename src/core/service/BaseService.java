  ...
  implements Service<E>
{
  ...
  {
    return (E)this.dao.get(id);
  }
  
  @Transactional(readOnly=true, propagation=Propagation.REQUIRED)
  public E getByProerties(String[] propName, Object[] propValue)
  {
    return (E)this.dao.getByProerties(propName, propValue);
  }
  ...
  {
    return (E)this.dao.getByProerties(propName, propValue, sortedCondition);
  }
  ...
  {
    return (E)this.dao.merge(entity);
  }
