...
import com.shengsheng.service.sys.AuthorityService;
...
public class SysUserController extends JavaEEFrameworkBaseController<SysUser> implements Constant {
	...
	@ResponseBody
	public Map getUserByRole(HttpServletRequest request, HttpServletResponse response){
		...
		try{
			...
			userList = sysUserService.getListByRole(role);
	...
	//获取社情民意报送类型字典
	@RequestMapping(value="/getTypeDict",method=RequestMethod.POST)
	@ResponseBody
	public void getTypeDit(HttpServletRequest request, HttpServletResponse response){
		Long id=Long.valueOf(request.getParameter("id"));
		Dict dict=dictService.getByProerties("id", id);
		List<Dict> dictList=dictService.queryByProerties("parentDictkey",dict.getDictKey());
		try {
			writeJSON(response, dictList);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public String student(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/systemmanage/student";
	}
	...
	@RequestMapping("/myOpinion")
	public String myOpinion(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/opinion/myOpinion";
	}
	...
	public String checkOpinion(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/opinion/checkOpinion";
	}
	@RequestMapping("/useOpinion")
	public String useOpinion(HttpServletRequest request, HttpServletResponse response) throws IOException {
		return "back/opinion/useOpinion";
	}
	
	@RequestMapping("/wl509user")
	public String wl509user(HttpServletRequest request, HttpServletResponse response) throws IOException {
        return "back/wl509/wl509user";
    }
	
	@RequestMapping("/registerUser")
    public String registerUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
        return "back/wl509/registerUser";
    }
	
	@RequestMapping("/userLogin")
    public String userLogin(HttpServletRequest request, HttpServletResponse response) throws IOException {
        return "back/wl509/userLogin";
    }
	
	@RequestMapping("/userRecord")
    public String userRecord(HttpServletRequest request, HttpServletResponse response) throws IOException {
        return "back/wl509/userRecord";
    }
