...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   titleBar:{titleBar_height:36,titleBar_bgColor:"#000000",titleBar_alpha:0.6},//标题背景样式，(isHasTitleBar = true 前提下启用)
		   isHasTitleFont:true,//是否显示标题文字 
		   titleFont:{TitleFont_size:14,TitleFont_color:"#FFFFFF",TitleFont_family:"microsoft yahei",TitleFont_weight:"bold"},//标题文字样式，(isHasTitleFont = true 前提下启用)
		   isHasBtn:true, //是否显示按钮
		   btn:{btn_bgColor:"#555555",btn_bgHoverColor:"#CC0000",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#FFFF00",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#FF0000",btn_borderWidth:1,btn_bgAlpha:0.8} //按钮样式设置，(isHasBtn = true 前提下启用)
	  },settings);
